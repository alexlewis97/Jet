...
const RecipientService_1 = require("./RecipientService");
...
describe('PreviewService', () => {
    ...
    let templateService;
    beforeEach(() => {
        recipientService = new RecipientService_1.RecipientService();
        aggregationService = new AggregationService_1.AggregationService();
        templateService = new TemplateService_1.TemplateService();
        previewService = new PreviewService_1.PreviewService(recipientService, aggregationService);
    });
    describe('generatePreview', () => {
        ...
        it('should render aggregations in template', async () => {
            const template = templateService.createTemplate('<html><body>Total: {{aggregation.Total Revenue}}</body></html>');
            const config = {
                id: 'test-config-2',
                label: 'Test Config',
                template,
        ...
        it('should detect unresolved placeholders', async () => {
            const template = templateService.createTemplate('<html><body>Total: {{aggregation.Missing}}</body></html>');
            const config = {
                id: 'test-config-4',
                label: 'Test Config',
                template,
